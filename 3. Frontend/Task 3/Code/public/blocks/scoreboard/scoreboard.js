...
var pug_match_html=/["&<>]/;
function pug_rethrow(n,e,r,t){if(!(n instanceof Error))throw n;if(!("undefined"==typeof window&&e||t))throw n.message+=" on line "+r,n;try{t=t||require("fs").readFileSync(e,"utf8")}catch(e){pug_rethrow(n,null,r)}var i=3,a=t.split("\n"),o=Math.max(r-i,0),h=Math.min(a.length,r+i),i=a.slice(o,h).map(function(n,e){var t=e+o+1;return(t==r?"  > ":"    ")+t+"| "+n}).join("\n");throw n.path=e,n.message=(e||"Pug")+":"+r+"\n"+i+"\n\n"+n.message,n}function scoreboard(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {var pug_debug_sources = {"public\u002Fblocks\u002Fscoreboard\u002Fscoreboard.pug":"h2 'Список пользователей'\ntable\n    thead\n        tr\n            th 'Email'\n            th 'Scores'\n    tbody\n        tr\n            each user in users\n                th #{user.email}\n                th #{user.score}\n"};
...
;pug_debug_line = 1;pug_debug_filename = "public\u002Fblocks\u002Fscoreboard\u002Fscoreboard.pug";
pug_html = pug_html + "'Список пользователей'\u003C\u002Fh2\u003E";
...
pug_html = pug_html + "\u003Cth\u003E";
;pug_debug_line = 11;pug_debug_filename = "public\u002Fblocks\u002Fscoreboard\u002Fscoreboard.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = user.score) ? "" : pug_interp)) + "\u003C\u002Fth\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Ftr\u003E\u003C\u002Ftbody\u003E\u003C\u002Ftable\u003E";}.call(this,"users" in locals_for_with?locals_for_with.users:typeof users!=="undefined"?users:undefined));} catch (err) {pug_rethrow(err, pug_debug_filename, pug_debug_line, pug_debug_sources[pug_debug_filename]);};return pug_html;}